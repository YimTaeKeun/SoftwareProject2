...
#define _DUTY_MAX 1972 // 2000
#define _DUTY_NEU 1363 // 1500
#define _DUTY_MIN 787 // 1000

#define _SERVO_ANGLE_DIFF  78  // Replace with |D - E| degree
...
float volt_to_distance(int a_value)
{
  ...
  // return (6762.0 / (a_value - 9) - 4.0) * 10.0; 
   return 1003.0 - 5.35 * a_value + 0.0101 * pow(a_value, 2) - 6.66 * pow(10, -6) * pow(a_value, 3);
}
